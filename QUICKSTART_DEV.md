# Emare Flow — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/emareflow
...
| 6 | `emareflow_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `emareflow Dervishi` bu projeden sorumlu
