...
```python
# Emare Flow — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'emareflow.view',      # Görüntüleme
    'emareflow.create',    # Oluşturma
    'emareflow.edit',      # Düzenleme
    'emareflow.delete',    # Silme
    'emareflow.manage',    # Tam yönetim
    # Admin
    'emareflow.admin',     # Admin panele erişim
    'emareflow.users',     # Kullanıcı yönetimi
    'emareflow.settings',  # Ayar yönetimi
]
```
...
```python
# emareflow/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'emareflow.view', 'emareflow.create',
        'emareflow.edit', 'emareflow.delete',
        'emareflow.manage', 'emareflow.users',
        'emareflow.settings', 'emareflow.admin',
    },
    'operator': {
        'emareflow.view', 'emareflow.create',
        'emareflow.edit',
...
| Proje Admini | admin@emareflow.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@emareflow.emare.dev | super_admin | Machine-to-machine |
